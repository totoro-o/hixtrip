...
public class OrderController {
    ...
    public R order(@RequestBody CommandOderCreateDTO commandOderCreateDTO) {
        //登录信息可以在这里模拟
        var userId = "001";
        String skuId = "sku001";
        Integer amount = 10;
        commandOderCreateDTO.setUserId(userId);
        commandOderCreateDTO.setAmount(amount);
        commandOderCreateDTO.setSkuId(skuId);
    ...
    public R payCallback(@RequestBody CommandPayDTO commandPayDTO) {
