...
public class OrderController {
     ...
     *
     * @param commandPayDTO 入参对象 支付三种场景枚举：PayCallbackStatusEnum
     * @return 请修改出参对象
     */
    @PostMapping(path = "/command/order/pay/callback")
    public PayCallbaskVO payCallback(@RequestBody CommandPayDTO commandPayDTO) {
        return orderService.payCallbask(commandPayDTO);
    }
