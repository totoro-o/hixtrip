...
public class OrderController {
    ...
    public OrderVO order(@RequestBody OrderReq orderReq) {
        //登录信息可以在这里模拟
        var userId = 0L;
     ...
     * @param paymentType 请修改入参对象
     * @return 请修改出参对象
     */
    @PostMapping(path = "/command/order/pay/callback")
    public String payCallback(@RequestBody PayCallback paymentType) {
        orderService.payCallback(paymentType);
        return "";
    }
