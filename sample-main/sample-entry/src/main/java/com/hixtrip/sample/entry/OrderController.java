...
public class OrderController {
    ...
    public Order order(@RequestBody CommandOderCreateDTO commandOderCreateDTO) {
        //登录信息可以在这里模拟
        var loginAccount = "admin";
        Order order = orderService.order(commandOderCreateDTO, loginAccount);
        return order;
    }
    ...
    public String payCallback(@RequestBody CommandPayDTO commandPayDTO) {
        String msg = orderService.payCallback(commandPayDTO);
        return msg;
    }
